    ...
    <div className="max-w-full mx-auto py-16 px-6 lg:px-24 bg-white">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-2 gap-6 bg-amber-50 p-6 rounded-2xl border border-amber-100">
            <div>
        ...
        <div className="bg-[#f6fbf9] p-8 md:p-12 rounded-[40px] border border-emerald-100 sticky top-10">
