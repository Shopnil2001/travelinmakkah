...
const handlePackageClick = (id) => {
    router.push(`/site/Hajj/${id}`); // Assuming your details page is at /hajj/[id]
  };
  const inputClass =
  ...
  return (
    <div className="bg-white">
      ...
      <section ref={formRef} className="py-16 px-6 md:px-12 lg:px-24">
        <div className="max-w-7xl mx-auto border border-blue-400 rounded-3xl overflow-hidden relative shadow-sm bg-white">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 flex items-center bg-white px-5 py-2 border-x border-b border-blue-400 rounded-b-2xl z-10 shadow-sm">
              ...
              <div className="pt-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <motion.button
                    whileTap={{ scale: 0.98 }}
                    disabled={isSending}
                    className="mt-4 bg-[#64B5F6] text-white px-10 py-3.5 rounded-xl font-semibold text-lg transition-colors hover:bg-[#008f45] shadow-md shadow-blue-400 disabled:opacity-60"
                  >
